...
from common.constants import SQL_FOLDER_NAME_COLUMN_NAME, SQL_RIGHT_ASCENSION_COLUMN_NAME, SQL_DECLINATION_COLUMN_NAME, \
    ...
    SQL_ANGULAR_DIAMETER_COLUMN_NAME, SQL_LATITUDE_COLUMN_NAME, SQL_LONGITUDE_COLUMN_NAME
