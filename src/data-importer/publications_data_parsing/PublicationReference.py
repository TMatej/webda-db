...
from common.constants import SQL_REF_FILE_NAME_COLUMN_NAME, SQL_REF_STRING_COLUMN_NAME, SQL_REF_NUMBER_COLUMN_NAME, \
    ...
    SQL_PUBLICATION_YEAR_COLUMN_NAME
...
class PublicationReference(InsertLineBuilderBase):
    ...
    def get_table_parameters() -> str:
        return f"{SQL_REF_FILE_NAME_COLUMN_NAME}, {SQL_REF_NUMBER_COLUMN_NAME}, {SQL_TITLE_COLUMN_NAME}, {SQL_AUTHOR_COLUMN_NAME}, {SQL_JOURNAL_COLUMN_NAME}, {SQL_PUBLICATION_YEAR_COLUMN_NAME}, {SQL_BIBCODE_COLUMN_NAME}"